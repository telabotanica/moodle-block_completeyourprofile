...
$string['check_for_user_picture'] = "Check for user picture";
$string['check_for_user_picture_desc'] = "Check if the user has uploaded a picture, if not then the profile will not be considered complete";
$string['check_for_interests'] = "Check for interests";
$string['check_for_interests_desc'] = "Check if the user has added any interests as tags, if not then the profile will not be considered complete";
...
$string['display_form_text'] = "Display form inline";
$string['display_form_text_desc'] = "Display form inline";
